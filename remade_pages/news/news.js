        ...
        graphql`
          query   {
              ...
              logo_ibc: file(relativePath: {eq: "logo_ibc.jpg"}) {
                  childImageSharp {
                      fluid(maxWidth: 356, maxHeight: 134) {
                      ...GatsbyImageSharpFluid
                      }
                  }
              }
     ...
     <div className="page news_page">
      <div className="container">
        ...
        <div className="news_wrapper">
          ...
          <Link to="/news_cstb-2009.html" className="news_item">
            <div className="title">
          ...
          <Link to="/news_cstb-2008.html" className="news_item">
            <div className="title">
          ...
          <Link to="/news_eebc-2008.html" className="news_item">
            <div className="title">
