        ...
        <div className="container">
          ...
          <div className="products_wrapper">
            ...
            <Link to="/catch_up_server" className="product_item">
              <h4 className="title">Мощный Catch-up сервер для IPTV вещания</h4>
              ...
              <hr></hr>
              <span>Сервер Crypton Catch-up TV - это высокопроизводительный програмно-аппаратный комплекс для организации услуг Live IPTV и отложенного просмотра телевизионных программ (Catch-up TV) в сетях мультисервисных операторов (MSO) и провайдеров интернет услуг (ISP).</span>
            </Link>
          </div>
